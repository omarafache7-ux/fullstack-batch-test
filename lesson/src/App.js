...
//   const mayaAss = () => {
//     return alert("Maya Ass was juicy");
//   };
//   return (
...
//               <button className="formButton" onClick={mayaAss}>
//                 Add payment
//               </button>
//             </div>
//           </div>
  ...
  return(
    ...
    <div className="app">
        <header className="catalogue-header">
          <h1>(‿ˠ‿)Premium Omar Women𓀐</h1>
          <p>Experience Omar Afache collection of high quality women he met</p>
          </header>  
          <ProductGrid/>
    </div>
    </>
